            ...
            <tbody>
              {data.map((item, idx) => (
                <tr key={item.id || idx}>
                  ...
                  <td>
                    <button className="btn btn-sm btn-info" data-bs-toggle="modal" data-bs-target={`#activityModal${idx}`}>Dettagli</button>
                      ...
                      <div className="modal-dialog">
                        <div className="modal-content">
                          <div className="modal-header">
                            <h5 className="modal-title" id={`activityModalLabel${idx}`}>Dettagli attività</h5>
